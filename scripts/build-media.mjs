...
const altText = {
  ...
  "software/en/home.png": { "zh-CN": "MAIXON V6.3 英文生产概览", en: "MAIXON V6.3 Production Overview" },
  "software/en/dtf.png": { "zh-CN": "MAIXON V6.3 英文 DTF 工作区", en: "MAIXON V6.3 DTF workspace" },
  "software/en/sublimation.png": { "zh-CN": "MAIXON V6.3 英文热升华工作区", en: "MAIXON V6.3 Sublimation workspace" },
  "software/en/ai.png": { "zh-CN": "MAIXON V6.3 英文 AI 工作区", en: "MAIXON V6.3 AI workspace" },
