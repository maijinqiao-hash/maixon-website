...
const zhTopics: GuideTopic[] = [
  {
    ...
    sections: [
      ...
      {
        title: "首次启动",
        body: "打开 MAIXON TOOL V5.9，进入账号入口并确认软件界面能够正常显示。",
...
const enTopics: GuideTopic[] = [
  {
    ...
    sections: [
      ...
      { title: "First launch", body: "Open MAIXON TOOL V5.9, enter the account area and confirm that the interface loads correctly.", notes: ["If installation or launch fails, record the on-screen message and software version before contacting support."] }
    ]
  },
  {
    slug: "account",
